namespace Cloud.GoogleDrive
{
    public static class GoogleAppsmimeType
    {
        ...
        public const string form = "application/vnd.google-apps.form";
        public const string fusiontable = "application/vnd.google-apps.fusiontable";
        public const string map = "application/vnd.google-apps.map";
        public const string photo = "application/vnd.google-apps.photo";
        ...
        public const string sites = "application/vnd.google-apps.sites";
        ...
        public const string video = "application/vnd.google-apps.video";
    }
}
